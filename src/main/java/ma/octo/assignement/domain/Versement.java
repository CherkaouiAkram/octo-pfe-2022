...
// Dans cette classe, on va pas utiliser le numéro de compte de l'émetteur
// car ce n'est pas nécessaire contrairement au virement, tout en respectant le concept d'abstraction.
// Un versement nécessite un id du versement, le nom de l'émetteur et les données du bénéficiaire.
